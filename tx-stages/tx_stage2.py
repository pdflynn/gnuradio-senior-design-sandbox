...
class tx_stage2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Stage 2 TX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Stage 2 TX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tx_stage2")
        ...
        self.blocks_throttle_0_0 = blocks.throttle(gr.sizeof_gr_complex*1, (bandwidth/(1+eb)),True)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, (bandwidth/(1+eb)),True)
        ...
        self.blocks_message_strobe_random_0 = blocks.message_strobe_random( pmt.cons(pmt.PMT_NIL, pmt.make_u8vector(16, 0xAA)), blocks.STROBE_UNIFORM, 250, 0)


        ##################################################
        # Connections
        ##################################################
        self.msg_connect((self.blocks_message_strobe_random_0, 'strobe'), (self.digital_crc32_async_bb_1, 'in'))
        ...
        self.connect((self.blocks_throttle_0, 0), (self.blocks_tagged_stream_mux_0, 0))
        self.connect((self.blocks_throttle_0_0, 0), (self.blocks_tagged_stream_mux_0, 1))
    ...
    def set_eb(self, eb):
        self.eb = eb
        self.set_tx_rrc_taps(firdes.root_raised_cosine(self.nfilts, self.nfilts, 1.0, self.eb, (5*self.sps*self.nfilts)))
        self.blocks_throttle_0.set_sample_rate((self.bandwidth/(1+self.eb)))
        self.blocks_throttle_0_0.set_sample_rate((self.bandwidth/(1+self.eb)))
