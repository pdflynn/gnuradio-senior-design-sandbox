...
class bpsk_no_fec(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "bpsk_no_fec")
        ...
        self.delay_val = delay_val = 200
        self.center = center = 2210
        self.baseband_bit_rate = baseband_bit_rate = 512

        ##################################################
        # Blocks
        ##################################################
        self._delay_val_range = Range(0, 250, 1, 200, 200)
        self._delay_val_win = RangeWidget(self._delay_val_range, self.set_delay_val, 'Delay', "counter_slider", float)
        ...
        self.blocks_vco_f_0 = blocks.vco_f(samp_rate, 15708, .5)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/danny/development/hamming-bpsk-transmitter/transmit_msg.txt', True, 0, 1024)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, delay_val)
    ...
    def get_baseband_bit_rate(self):
        return self.baseband_bit_rate

    def set_baseband_bit_rate(self, baseband_bit_rate):
        self.baseband_bit_rate = baseband_bit_rate



def main(top_block_cls=bpsk_no_fec, options=None):
