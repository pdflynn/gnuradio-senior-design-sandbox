...
class bpsk_stage6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.zeromq_pull_source_0, 0), (self.blocks_unpack_k_bits_bb_0_0, 0))
        self.connect((self.zeromq_pull_source_0, 0), (self.digital_constellation_modulator_0, 0))
