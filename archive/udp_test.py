...
class udp_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.blocks_udp_sink_0 = blocks.udp_sink(gr.sizeof_char*1, "127.0.0.1", 40868, 128, True)
        ...
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.blocks_udp_sink_0, 0))
