...
class senior_design_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "senior_design_test")
        ...
        self.limesdr_sink_0.set_center_freq(915e6, 0)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/danny/development/gnuradio-sandbox/transmit.txt', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/danny/development/gnuradio-sandbox/sr_design_rx.txt', False)
        ...
        self.connect((self.blocks_unpack_k_bits_bb_1, 0), (self.blocks_char_to_float_0_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_1, 0), (self.digital_constellation_modulator_0, 0))
        self.connect((self.digital_constellation_decoder_cb_0, 0), (self.blocks_char_to_float_0, 0))
        self.connect((self.digital_constellation_decoder_cb_0, 0), (self.digital_diff_decoder_bb_0, 0))
        self.connect((self.digital_constellation_modulator_0, 0), (self.limesdr_sink_0, 0))
        self.connect((self.digital_costas_loop_cc_0_0, 0), (self.digital_constellation_decoder_cb_0, 0))
        self.connect((self.digital_diff_decoder_bb_0, 0), (self.digital_map_bb_0, 0))
        self.connect((self.digital_map_bb_0, 0), (self.blocks_unpack_k_bits_bb_0, 0))
        self.connect((self.osmosdr_source_0, 0), (self.digital_costas_loop_cc_0_0, 0))
...
def main(top_block_cls=senior_design_test, options=None):
