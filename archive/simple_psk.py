...
class simple_psk(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "simple_psk_20220831")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("simple_psk_20220831")
        ...
        self.settings = Qt.QSettings("GNU Radio", "simple_psk")
        ...
        self.digital_constellation_receiver_cb_0 = digital.constellation_receiver_cb(bpsk, 0.06283185307, 0, 1.5)
...
def main(top_block_cls=simple_psk, options=None):
