...
class qpsk_tutorial_1_simple(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk_tutorial_1_simple")
        ...
        self.qpsk = qpsk = digital.constellation_rect([-.707-.707j, -.707+.707j, .707+.707j, .707-.707j], [0, 1, 3, 2],
        4, 2, 2, 1, 1).base()
        ...
        self._timing_loop_bw_win = RangeWidget(self._timing_loop_bw_range, self.set_timing_loop_bw, 'Timing Loop Bandwidth', "counter_slider", float)
        self.top_grid_layout.addWidget(self._timing_loop_bw_win)
        self._time_offset_range = Range(.999, 1.001, 100e-6, 1.0005, 200)
        self._time_offset_win = RangeWidget(self._time_offset_range, self.set_time_offset, 'Channel Time Offset', "counter_slider", float)
        self.top_grid_layout.addWidget(self._time_offset_win)
        self._noise_volt_range = Range(0, 1, 0.1, .2, 200)
        ...
        self.qtgui_const_sink_x_0_0.set_update_time(0.02)
        ...
        self.qtgui_const_sink_x_0 = qtgui.const_sink_c(
            2048, #size
            'Timing Recovery', #name
            1 #number of inputs
        )
        self.qtgui_const_sink_x_0.set_update_time(0.02)
...
def main(top_block_cls=qpsk_tutorial_1_simple, options=None):
