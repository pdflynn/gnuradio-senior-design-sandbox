...
# Title: PSK_Simulation_Senior_Design
...
class sr_design_test_20220813(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PSK_Simulation_Senior_Design")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PSK_Simulation_Senior_Design")
        ...
        self.settings = Qt.QSettings("GNU Radio", "sr_design_test_20220813")
        ...
        self.variable_constellation_rect_0 = variable_constellation_rect_0 = digital.constellation_rect([-0.707-0.707j, -0.707+0.707j, 0.707+0.707j, 0.707-0.707j], [0, 1, 2, 3],
        4, 2, 2, 1, 1).base()
        ...
        self.digital_constellation_modulator_0 = digital.generic_mod(
            ...
            verbose=False,
            log=False)
        self.digital_cma_equalizer_cc_0 = digital.cma_equalizer_cc(15, 0, 1, 2)
...
def main(top_block_cls=sr_design_test_20220813, options=None):
