...
class bpsk_stage6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "bpsk_stage6")
        ...
        self.zeromq_push_sink_0 = zeromq.push_sink(gr.sizeof_char, 1, 'tcp://127.0.0.1:50251', 1000, False, -1)
        self.zeromq_pull_source_0 = zeromq.pull_source(gr.sizeof_char, 1, 'tcp://127.0.0.1:50252', 100, False, -1)
        ...
        self.blocks_throttle_1 = blocks.throttle(gr.sizeof_char*1, bps,True)
        ...
        self.connect((self.blocks_throttle_1, 0), (self.blocks_unpack_k_bits_bb_0_0, 0))
        self.connect((self.blocks_throttle_1, 0), (self.digital_constellation_modulator_0, 0))
        ...
        self.connect((self.zeromq_pull_source_0, 0), (self.blocks_throttle_1, 0))
    ...
    def set_bps(self, bps):
        self.bps = bps
        self.blocks_throttle_1.set_sample_rate(self.bps)
