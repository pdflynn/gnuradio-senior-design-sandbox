...
class adsbsine(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "adsbsine")
        ...
        self._bb_gain_range = Range(0, 100, 1, 1, 200)
        ...
        self.osmosdr_sink_0.set_center_freq(1090e6, 0)
...
def main(top_block_cls=adsbsine, options=None):
